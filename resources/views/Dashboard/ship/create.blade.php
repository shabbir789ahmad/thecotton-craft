  ...
  <a href="{{route('ship.index')}}">
    <div class="card shadow border p-0 ">
      <div class="card-body text-dark">
       <i class="fab fa-slideshare text-success fa-lg"></i>Shipping
       </div>
    </div></a>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-8 card col-sm-10 border border-success mt-5 p-5">
      ...
      <label class="mt-3 font-weight-bold">City</label>
      <div class="form-group">
       <div class="input-group clockpicker" id="clockPicker1">   
        <input type="text" name="city" placeholder="Title" class="form-control "  value="{{old('city')}}" required=""><br>
      ...
      <span class="text-danger">@error('city') {{$message}} @enderror</span>
        <label class="mt-3 font-weight-bold">Shipping Cost</label>
      <div class="form-group">
       <div class="input-group clockpicker" id="clockPicker1">   
       <input type="text" name="shipping_cost" placeholder="Shipping Cost" class="form-control "  value="{{old('shipping_cost')}}" required=""><br>
      ...
      <span class="text-danger">@error('shipping_cost') {{$message}} @enderror</span>
