...
<div class="c ml-3  d-flex mr-1">
  ...
  <div class="card shadow border ml-auto w-50 p-0 ">
   <div class="card-body text-dark">
    <h4 class="text-center font-weight-bold text-color">Upload Color</h4>
   </div>
  </div>
    ...
    <div class="col-md-8 card col-sm-10 border border-success mt-5 p-5">
      ...
      <div class="form-group">
       <div class="input-group clockpicker" id="clockPicker1">   
        <input type="text" name="colors" placeholder="Color Name" class="form-control "  value="{{old('colors')}}" required=""><br>
      ...
      <div class="form-group">
       <div class="input-group clockpicker" id="clockPicker1">   
        <input type="text" name="color_name" placeholder="Color Name" class="form-control "  value="{{old('color_name')}}" required=""><br>
