...
<div class="c ml-3  d-flex mr-1">
  ...
  <div class="card shadow border ml-auto w-50 p-0 ">
   <div class="card-body text-dark">
    <h4 class="text-center font-weight-bold text-color">Upload Size</h4>
   </div>
  </div>
    ...
    <div class="col-md-8 card col-sm-10 border border-success mt-5 p-5">
      ...
      <div class="form-group">
       <div class="input-group clockpicker" id="clockPicker1">   
        <input type="text" name="product_size" placeholder="Size sm ,md,lg" class="form-control "  value="{{old('product_size')}}" required=""><br>
      ...
      <div class="form-group">
       <div class="input-group clockpicker" id="clockPicker1">   
        <input type="text" name="size_name" placeholder="Size Name like small for sm md for medium " class="form-control "  value="{{old('size_name')}}" required=""><br>
