...
<div class="card">
 <div class="card-body">
  <div class="row">
    <div class="col-md-1 col-sm-1  mt-3 mb-2" >
     ...
     @foreach($image as $d)
      <div class="box  " onclick="changepic(this)">
        <img  id="img1" src="{{asset('uploads/img/'.$d['rimage'])}}" width="100%" height="100rem" class=" d-block mt-1">
       </div>
     ...
     <div class="con mt-1  " id="mimage">
      ...
      @if($loop->first)
       <img  id="mimg" src="{{asset('uploads/img/' .$d['rimage'])}}" class="img-fluid d-block imgb border rounded" style="width: 90%; height: 35rem; overflow: hidden; ">
        <a href="{{url('/delete-image/' .$d['id'])}}"> <p class="overlay2 ">Delete</p></a> 
   ...
   <h6 class="font-weight-bold mt-3">General Detail</h6> 
    <hr class="mt-2">
   <div class="forme ">
    <form class="mt-4" action="{{url('/update-product-detail2')}}" method="POST" enctype="multipart/form-data">
      @csrf
    ...
    <input type="hidden" name="sub_id" value="{{$product['sub_id']}}">
     <div class="form-group ml-2">
      <label class="mr-3 ml-1 font-weight-bold">Product Name</label>
    ...
    <div class="form-group ml-2">
      <label class="mr-3 ml-1 font-weight-bold">Product Detail</label>
      <div class="input-group clockpicker" id="clockPicker1">
        
        <textarea class="form-control border-secondary" name="detail" rows="5" placeholder="Product details Here" required>{{$product['detail']}}</textarea> 
        <div class="input-group-append">
         <span class="input-group-text"><i class="fab fa-product-hunt"></i></span>
       </div>                      
    </div>
     ...
     <div class="form-group ml-2">
       <label class="mr-3 ml-1 font-weight-bold">Product price</label>
      <div class="input-group clockpicker" id="clockPicker1">
  ...
  <div class="form-group ml-2">
       <label class="mr-3 ml-1 font-weight-bold">Product Discount</label>
      <div class="input-group clockpicker" id="clockPicker1">
  ...
  <div class="form-group ml-2 ">
    <label class="mr-3 font-weight-bold">Total Product</label>
     <div class="input-group clockpicker" id="clockPicker1">
  ...
  <div class="form-group ml-2 ">
    <label class="mr-3 font-weight-bold">New Images</label>
     <div class="input-group clockpicker" id="clockPicker1">
        
       <input type="file" name="rimage[]"  class="form-control" multiple>
        <div class="input-group-append" >
         <span class="input-group-text"><i class="fab fa-product-hunt"></i></span>
       </div>                      
    </div>
   ...
   <button class="btn-color btn text-light btn-block mt-3">Update</button>
    </form>
   </div>
...
<div class="card">
 <div class="card-body">
   <h6 class="font-weight-bold text-danger">Apply Promo </h6>
    ...
    <hr class="mt-2">
     ...
     @foreach($colors as $color)
      ...
      <i class="fas fa-circle fa-2x "
       ...
       <a href="{{url('/delete-color/' .$color['id'])}}">
...
<div class="card">
  <div class="card-body">
    <h6 class="font-weight-bold">Sizes <span class="float-right"><i class="fas fa-plus text-success p-2 border  shadow" data-toggle="modal" data-target="#size-modal2"> </i></span></h6>
     <hr class="mt-2">
    <div class=" top_cat ">
       @foreach($size as $siz)  
        @if($siz) 
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mt-3">
        <form action="{{url('/update-store')}}" method="POST">
            @csrf
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mt-3">
        ...
        <button class="btn-color btn text-light float-right mt-5 btn-lg">Upload</button>
         </form>
      </div>
    </div>
  </div>
         ...
         <div class="form-group">
          <div class="input-group clockpicker" id="clockPicker1">  
            <select class="form-control" name="color">
              ...
              <option value="{{$color['colors']}}">{{ucfirst($color['color_name'])}} </option>
              @endforeach
            </select>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mt-3">
        <form action="{{url('/update-image')}}" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
          <div class="input-group clockpicker" id="clockPicker1">  
            <input type="file" name="imgs" class="form-control " ><br>
