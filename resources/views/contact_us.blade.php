...
<div class="col-md-6 ">
   <p class="get2 font-weight-bold text-center">Contact Info</p>
          <p class="prom2 text-center">Email,Call Or Visit as About Your Queries!</p>
      ...
      <div class="row">
          ...
          <div class="col-md-10 col-10 ">
           <p class="phone ml-3">{{$link['phone']}}</p>
