...
<div class="container mb-5">
   ...
   <div class="row">
    ...
    <a href="{{route('your.orders')}}"style="text-decoration:none; color: #000;"> <div class="card shadow user-card-hover">
      <div class="card-body" style="height:8rem">
        <div class="d-flex">
          <img src="{{asset('pic/order._CB660668735_.png')}}" width="25%">
          <div class="text-user ml-3">
           <h6 class="order-user">Your order</h6>
           <p class="product-detail3">Track, buy Again</p>
          </div>
        </div>
      </div>
     </div>
    ...
    <div class="col-md-4 col-12">
    <a href="{{url('/login-and-securty')}}"style="text-decoration:none;color: #000;">	<div class="card shadow user-card-hover">
      <div class="card-body" style="height:8rem">
        <div class="d-flex">
    ...
    <div class="col-md-4 col-12">
   <a href="{{url('user_profile')}}"style="text-decoration:none;color: #000;">
  ...
  <!--   <div class="col-md-4 col-12 mt-4">
    <a href="{{url('user_message')}}"style="text-decoration:none;color: #000;">
     <div class="card shadow user-card-hover">
      <div class="card-body" style="height:8rem">
        <div class="d-flex">
    ...
    <div class="col-md-4 col-12 mt-4">
   <a href="{{url('get-wishlist')}}"style="text-decoration:none;color: #000;">
     <div class="card shadow user-card-hover">
      <div class="card-body" style="height:8rem">
        <div class="d-flex">
      ...
      <div class="card-body" style="height:8rem">
        <div class="d-flex">
          ...
          <div class="text-user ml-3">
           ...
           <p class="product-detail3">View,Manage Your Cart</p>
          </div>
        </div>
      </div>
     </div>
